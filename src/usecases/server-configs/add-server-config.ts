...
import { mapEntityToModel, mapModelToEntity } from "@/mappers/server-config-mapper";

export const addServerConfigUseCase = async (context: {repo: IServerConfigRepository}, data: {server: ServerConfigModel}): Promise<ServerConfigModel
> => {
