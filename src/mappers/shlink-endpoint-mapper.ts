...
export const mapEntityToModel = (shlinkEndpointEntity: SHLinkEndpointEntity): SHLinkEndpointModel | undefined => {
    return shlinkEndpointEntity ? new SHLinkEndpointModel(
...
export const mapModelToEntity = (shlinkEndpointModel: SHLinkEndpointModel): SHLinkEndpointEntity | undefined => {
...
export const mapModelToDto = (shlinkEndpointModel: SHLinkEndpointModel): SHLinkEndpointDto | undefined => {
...
export const mapDtoToModel = (shlinkEndpointDto: SHLinkEndpointDto): SHLinkEndpointModel | undefined => {
    return shlinkEndpointDto ? new SHLinkEndpointModel(
