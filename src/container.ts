...
export const ServerConfigRepositoryToken = Symbol(
  'ServerConfigPrismaRepository',
);
...
export class Container {
  ...
  constructor() {
    this.services.set(
      ...
      new ServerConfigPrismaRepository(prisma),
    );
    this.services.set(UserRepositoryToken, new UserPrismaRepository(prisma));
    this.services.set(
      SHLinkRepositoryToken,
      new SHLinkPrismaRepository(prisma),
    );
    this.services.set(
      SHLinkAccessRepositoryToken,
      new SHLinkAccessPrismaRepository(prisma),
    );
    this.services.set(
      AccessTicketRepositoryToken,
      new AccessTicketPrismaRepository(prisma),
    );
    this.services.set(
      SHLinkEndpointRepositoryToken,
      new SHLinkEndpointPrismaRepository(prisma),
    );
  }
