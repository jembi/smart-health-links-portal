/*
  ...
  - You are about to drop the column `config_passcodeHash` on the `shlink` table. All the data in the column will be lost.
...
INSERT INTO "new_shlink" ("active", "config_exp", "config_passcode", "id", "management_token", "name", "passcode_failures_remaining", "user_id") SELECT "active", "config_exp", "config_passcode", "id", "management_token", "name", "passcode_failures_remaining", "user_id" FROM "shlink";
DROP TABLE "shlink";
